...
/* **************infiSTAR Copyright®© 2011 - 2020 All rights reserved.************** */
/* *********************************www.infiSTAR.de********************************* */
diag_log '<infiSTAR.de> VERSION: infiSTAR.de 18-05-2020 07-11-51 (v0260)';
comment 'Antihack & AdminTools - Christian Lorenzen - www.infiSTAR.de - License: (CC)';
UPDATEEMAIL='dastre84@gmail.com';
INFISTARVERSION='18-05-2020 07-11-51 - v0260';
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!    dastre84@gmail.com - 18-05-2020 07-11-51 - v0260 - %2 - %3',time,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [dastre84@gmail.com - 18-05-2020 07-11-51 - v0260 - %2 - %3]',_t,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!    dastre84@gmail.com - 18-05-2020 07-11-51 - v0260 - %2 - %3',_t,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = compileFinal "
	...
	diag_log format['<infiSTAR.de>%1| %2   [18-05-2020 07-11-51 - v0260]',_logname,_logentry];
...
_fnc_RandomGen =
{
	_fnc_actualGen = {
		...
		_arr = ['a','0','d','7','6','e','f','b','9','5','5','a','9','d','9','a','d','6','8','a','2','4','7','a','2','6','1','e','f','2','9'];
...
_log call FNC_A3_CONNECTLOG;
_m = missionNameSpace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=vi7882628988';missionNameSpace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
"; }; _A3AHstring = _A3AHstring + "
	...
	_hours = floor(serverTime / 60 / 60);_value = ((serverTime / 60 / 60) - _hours);if(_value == 0)then{_value = 0.0001;};_minutes = round(_value * 60);_seconds = 'vi7882628988x2';
	_devLog = format['<infiSTAR.de> %1 VERSION: infiSTAR.de 18-05-2020 07-11-51 (v0260) - server running: %2:%3:%4',VERSIONCHECKRESULT,_hours,_minutes,_seconds];diag_log _devLog;
...
_res = [VERSION_CHECK_URL_FULL+'&id=vi7882628988&li=0d76efb955a9d9ad68a247a261ef29&pr=A3'] call FN_ARMA_FETCHDATA;
