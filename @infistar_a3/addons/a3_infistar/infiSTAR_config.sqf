...
*/
_serverCommandPassword = 'adminRHjJMDw9';
...
*/
_passwordAdmin = 'commandRHjJMDw9';
...
[
	[
		['76561197964896870','76561198063536811','UID3','...'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> vi7882628988";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"a3"+";;"+_logname+";;"+_logentry+";;"+"18-05-2020 07-11-51 - v0260");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format["<infiSTAR.de>%1| %2   [18-05-2020 07-11-51 - v0260]",_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
